...
public:
  ...
  /**
   * @brief Reemplaza desde una posición el tamaño que quiera de un nuevo string
   * @param pos Posición desde la que quiere empezar a reemplazar
   * @param sz Posiciones que quiere reemplazar
   * @param str Referencia de un string que se quiere reemplazar 
   * @return Devuelve una referencia del nuevo string 
   **/ 
  ...
  /** 
   * @brief Separa un string segun el delimitador que se elija
   * @param Delimit Indica donde se separa la string
   * @return Devuelve una referencia de un vector de string con las partes separadas
   **/ 
